      ...
      >
        <div style={{ maxWidth: "1140px", margin: "0 auto" }}>
          ...
          <a
            ...
            style={{ color: THEME.textDim, textDecoration: "none" }}
          >
            Boubaker Jouini
          </a>{" "}
          · <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            style={{ color: THEME.textDim, textDecoration: "none", display: "inline-flex", alignItems: "center", gap: "3px", verticalAlign: "middle" }}
          >
