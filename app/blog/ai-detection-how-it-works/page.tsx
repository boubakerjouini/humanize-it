...
export default function AiDetectionHowItWorksPage() {
  return (
    <main className="max-w-3xl mx-auto px-4 py-12">
      ...
      {/* Perplexity */}
      <h2 style={h2Style}>What Is Perplexity in NLP?</h2>
      <p style={pStyle}>
      ...
      {/* Burstiness */}
      <h2 style={h2Style}>What Is Burstiness?</h2>
      <p style={pStyle}>
      ...
      {/* GPTZero */}
      <h2 style={h2Style}>How GPTZero and Similar Detectors Use These Metrics</h2>
      <p style={pStyle}>
      ...
      {/* Classifiers */}
      <h2 style={h2Style}>Classifier-Based Detection</h2>
      <p style={pStyle}>
      ...
      {/* Watermarking */}
      <h2 style={h2Style}>Watermarking Approaches</h2>
      <p style={pStyle}>
      ...
      {/* False positives */}
      <h2 style={h2Style}>Why False Positives Are Inevitable</h2>
      <p style={pStyle}>
      ...
      {/* HumanizeIt */}
      <h2 style={h2Style}>How HumanizeIt Does This Automatically</h2>
      <p style={pStyle}>
      ...
      <div className="bg-purple-700 text-white rounded-2xl p-8 text-center" style={{ marginTop: "48px" }}>
        ...
        <Link
          href="/sign-up"
          className="inline-block bg-white text-purple-700 font-bold rounded-xl px-8 py-3 text-lg hover:bg-gray-100 transition-colors"
        >
          Get Started Free
        </Link>
      </div>
