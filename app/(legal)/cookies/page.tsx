          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', marginTop: '8px' }}>
            <thead>
              <tr style={{ background: THEME.surface1 }}>
                <th style={{ padding: '10px 12px', textAlign: 'left', color: THEME.text, fontWeight: 600, fontSize: '13px', border: `1px solid ${THEME.border}`, fontFamily: THEME.fontMono }}>Cookie</th>
                <th style={{ padding: '10px 12px', textAlign: 'left', color: THEME.text, fontWeight: 600, fontSize: '13px', border: `1px solid ${THEME.border}`, fontFamily: THEME.fontMono }}>Provider</th>
                <th style={{ padding: '10px 12px', textAlign: 'left', color: THEME.text, fontWeight: 600, fontSize: '13px', border: `1px solid ${THEME.border}`, fontFamily: THEME.fontMono }}>Purpose</th>
                <th style={{ padding: '10px 12px', textAlign: 'left', color: THEME.text, fontWeight: 600, fontSize: '13px', border: `1px solid ${THEME.border}`, fontFamily: THEME.fontMono }}>Required</th>
              </tr>
            </thead>
            <tbody>
              {[
                ...
                <tr key={i} style={{ background: i % 2 === 0 ? 'transparent' : THEME.surface2 }}>
                  ...
                  <td style={{ padding: '10px 12px', fontSize: '13px', border: `1px solid ${THEME.border}`, fontFamily: THEME.fontMono, color: row.required === 'Yes' ? THEME.ai : THEME.human }}>{row.required}</td>
                </tr>
              ))}
            </tbody>
          </table>
