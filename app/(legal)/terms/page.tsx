  ...
  return (
    <>
      <div style={{ marginBottom: '48px' }}>
        <h1 style={{ fontSize: '36px', fontWeight: 700, color: '#fff', marginBottom: '8px' }}>Terms of Service</h1>
        <p style={{ color: '#555577', fontSize: '14px' }}>Effective date: March 5, 2026</p>
      </div>
      ...
      <Section title="3. Plans & Limits">
        <ul style={{ paddingLeft: '20px' }}>
          <li style={{ marginBottom: '8px' }}><strong style={{ color: '#e0e0f0' }}>Free:</strong> $0 — 500 words/day, 1 humanization/day</li>
          <li style={{ marginBottom: '8px' }}><strong style={{ color: '#e0e0f0' }}>Pro:</strong> $9/month or $79/year — 50,000 words/month, unlimited humanizations</li>
          <li style={{ marginBottom: '8px' }}><strong style={{ color: '#e0e0f0' }}>Team:</strong> $29/month or $249/year — 200,000 words/month, unlimited humanizations</li>
        </ul>
      ...
      <Section title="11. Contact">
        <p>For questions about these Terms: <strong style={{ color: '#e0e0f0' }}>support@humanizeit.app</strong></p>
      </Section>
    </>
  )
}
